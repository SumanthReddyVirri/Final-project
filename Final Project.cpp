...
text = """[1] The beginning of the gospel of Jesus Christ, the Son of God.
...
# Calculate SHA-256 hash for Mark 2
hash_obj_mark2 = hashlib.sha256(text_mark2.encode())
hash_value_mark2 = hash_obj_mark2.hexdigest()

print("SHA-256 Hash for Mark 2:", hash_value_mark2)
import hashlib
...
# Calculate SHA-256 hash for Mark 3
hash_obj_mark3 = hashlib.sha256(text_mark3.encode())
hash_value_mark3 = hash_obj_mark3.hexdigest()

print("SHA-256 Hash for Mark 3:", hash_value_mark3)
...
# Calculate SHA-256 hash for Mark 4
hash_obj_mark4 = hashlib.sha256(text_mark4.encode())
hash_value_mark4 = hash_obj_mark4.hexdigest()

print("SHA-256 Hash for Mark 4:", hash_value_mark4)
...
hash_obj_mark5 = hashlib.sha256(text_mark5.encode())
hash_value_mark5 = hash_obj_mark5.hexdigest()

print("SHA-256 Hash for Mark 5:", hash_value_mark5)
...
hash_obj_mark6 = hashlib.sha256(text_mark6.encode())
hash_value_mark6 = hash_obj_mark6.hexdigest()

print("SHA-256 Hash for Mark 6:", hash_value_mark6)
...
hash_obj_mark7 = hashlib.sha256(text_mark7.encode())
hash_value_mark7 = hash_obj_mark7.hexdigest()

print("SHA-256 Hash for Mark 7:", hash_value_mark7)
...
hash_obj_mark8 = hashlib.sha256(text_mark8.encode())
hash_value_mark8 = hash_obj_mark8.hexdigest()

print("SHA-256 Hash for Mark 8:", hash_value_mark8)


import hashlib

text_mark9 = """[1] And he said to them, "Truly, I say to you, there are some standing here who will not taste death before they see that the kingdom of God has come with power."
[2]
...
hash_obj_mark9 = hashlib.sha256(text_mark9.encode())
hash_value_mark9 = hash_obj_mark9.hexdigest()

print("SHA-256 Hash for Mark 9:", hash_value_mark9)

import hashlib

text_mark10 = """[1] And he left there and went to the region of Judea and beyond the Jordan, and crowds gathered to him again; and again, as his custom was, he taught them.
...
hash_mark10 = hashlib.sha256(text_mark10.encode()).hexdigest()
...
text_mark11 = """[1] And when they drew near to Jerusalem, to Beth'phage and Bethany, at the Mount of Olives, he sent two of his disciples,
...
# Calculate the SHA-256 hash
hash_mark11 = hashlib.sha256(text_mark11.encode()).hexdigest()
...
text_mark12 = """[1] And he began to speak to them in parables. "A man planted a vineyard, and set a hedge around it, and dug a pit for the wine press, and built a tower, and let it out to tenants, and went into another country.
...
[35] And as Jesus taught in the temple, he said, "Beware of the scribes, who like to go about in long robes, and to have salutations in the market places
...
# Calculate the SHA-256 hash
hash_mark12 = hashlib.sha256(text_mark12.encode()).hexdigest()
...
text_mark13 = """[1] And as he came out of the temple, one of his disciples said to him, "Look, Teacher, what wonderful stones and what wonderful buildings!"
...
# Calculate the SHA-256 hash
hash_mark13 = hashlib.sha256(text_mark13.encode()).hexdigest()

print(hash_mark13)

import hashlib

text_mark14 = """[1] It was now two days before the Passover and the feast of Unleavened Bread. And the chief priests and the scribes were seeking how to arrest him by stealth, and kill him;
...
# Calculate the SHA-256 hash
hash_mark14 = hashlib.sha256(text_mark14.encode()).hexdigest()
...
text_mark15 = """[1] And as soon as it was morning the chief priests, with the elders and scribes, and the whole council held a consultation; and they bound Jesus and led him away and delivered him to Pilate.
...
[29] And those who passed by derided him, wagging their heads, and saying, "Aha! You who would destroy the temple and build it in three days, save yourself, and come down from the cross!"
...
# Calculate the SHA-256 hash
hash_mark15 = hashlib.sha256(text_mark15.encode()).hexdigest()
...
text_mark16 = """[1] And when the sabbath was past, Mary Mag'dalene, and Mary the mother of James, and Salo'me, bought spices, so that they might go and anoint him.
...
# Calculate the SHA-256 hash
hash_mark16 = hashlib.sha256(text_mark16.encode()).hexdigest()
